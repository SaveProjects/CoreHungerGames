...
public class NoPVP extends BukkitRunnable
{
    ...
    public void run()
    {
        ...
        EdmineAPI.getInstance().getBossBarBuilder().setTitle("§fPVP actif dans: §c" + timer + "§cs");
        EdmineAPI.getInstance().getBossBarBuilder().setHealth(timer, core.getConfig().getInt("timers.nopvp"));
