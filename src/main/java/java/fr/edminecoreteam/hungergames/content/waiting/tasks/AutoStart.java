package fr.edminecoreteam.hungergames.content.waiting.tasks;
...
public class AutoStart extends BukkitRunnable
{
    ...
    public void run()
    {
        ...
        EdmineAPI.getInstance().getBossBarBuilder().setTitle("§fLancement: §a" + timer + "§as");
        EdmineAPI.getInstance().getBossBarBuilder().setHealth(timer, core.getConfig().getInt("timers.start"));
